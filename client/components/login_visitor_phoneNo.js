...
export default class login_visitor_phoneNo extends React.Component {
	constructor() {
		super();
		this.state = {
			phone_no: null,
			...
			<SafeAreaView style={styles.container}>
				<View style={styles.flexRow}>
					<View style={styles.flexCol_1}>
						<Text style={styles.title_reg}>Login as Premise Owner :</Text>
					</View>
				...
				<Text style={[styles.subtitle, styles.subtitle_bg]}>Visitor Login</Text>
